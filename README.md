...
Installing control-base
=======================

Installing `control-base` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating control-base-feedstock
===============================

If you would like to improve the control-base recipe or build a new
...
Note that all branches in the conda-forge/control-base-feedstock are
